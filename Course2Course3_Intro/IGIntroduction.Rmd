...
downloaded and installed these programs on your own computer or having access to
cloud-based versions of these programs via https://posit.cloud/. If you've
completed Course 1 from this series, you should already be familiar with the
purpose of independent guides for this course and do not need to read the rest
of this document. If you are brand new to R and RStudio, we recommend you work
through Course 1 in this series before proceeding.
...
conducting your analysis. Also like recipes, scripts are not useful unless you
