...
Observe that we wrote an R comment above. In R, any line that starts with a pound 
symbol (`#`, also called a hashtag) is ignored. It is meant as a way for the code writer
to communicate to the code reader. Sometimes they are the same person, meaning that
the person most likely to benefit from your comments is you. 
...
pressing Cmd+Enter (on your Mac) or Ctrl+Enter (on your Windows computer). Your 
'enter' key may be labeled as 'return' -- on American keyboards its the button at the far right. 
...
exists in the same folder as our project, which we can see from looking at the 
bottom-right panel of the RStudio session:

![**Image description: Files in your GlobalFindex folder**](project_files.png)
...
![**Image description: What your script looks like before saving**](unsaved_script.png)


Press Cmd+S (Mac) or Ctrl+S (Windows) to save your work, and it should change to
black font with no asterisk:

![**Image description: What your script looks like after saving**](saved_script.png)
