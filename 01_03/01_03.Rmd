...
and Lessons (if you are working on posit.cloud, you may skip to the end of this 
...
R projects are the **only** way to use RStudio on posit.cloud. In fact, 
you've already created a project on posit.cloud: recall that 
...
Whether you are working from your own computer or posit.cloud, for this next
...
on your harddrive, even after you close RStudio (or navigate out of posit.cloud). 
...
working on your own computer or on posit.cloud.
