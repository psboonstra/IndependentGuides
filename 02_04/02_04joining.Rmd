...
to join. By performing a full join of the datasets, we obtain a data frame of 
...
to convince yourself why `left_join(x, y)` will yield the same result as `right_join(y, x)` (except
that the order of the columns will be different). 
